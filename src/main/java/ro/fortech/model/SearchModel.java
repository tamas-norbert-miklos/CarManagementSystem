...
/**
 * Represents a command object used for the searchByUsername form.
 * The Car object has only one field for engine type and because
 * of this it can't be used as command object for the searchByUsername form.
 * Instances of this class will have the role of command object
 * for the applications searchByUsername algorithm.
